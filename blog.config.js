...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '往事并不如风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '互联网技术人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.Nobody.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'architecture, software, cat', // 网站关键词 英文逗号隔开
